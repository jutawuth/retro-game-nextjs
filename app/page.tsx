      ...
      <div className=" flex min-h-screen flex-wrap justify-center  p-4">
        <div className=" w-full justify-center text-red-500">
          ...
          <ol className=" text-4xl  mb-20 text-left">
            ...
            <li>
              3. ต้องตอบชื่อเพลง และ/หรือ ศิลปิน ให้ถูกต้อง (นับตั้งแต่ประโยคแรก ห้าม เอ่อ อ่า
              เอ๋)
            </li>
            <li>
              4. หากตอบถูกจะได้เลือกเพลงข้อถัดไป
              <ol className=" text-4xl ml-6 text-left">
                <li> 4.1 ตอบ <u>ศิลปิน</u> ถูกได้ 1 คะแนน</li>
                <li> 4.2 ตอบ <u>ชื่อเพลง</u> ถูกได้ 3 คะแนน</li>
                <li>4.3 ตอบ <u>ชื่อเพลง และ ศิลปิน</u> ถูกได้ 5 คะแนน</li>
              </ol>
            </li>
